...
function cleanUndefinedFields(apps) {
    return apps.map((app) => {
        const leanApp = Object.fromEntries(Object.entries(app).filter((entry) => entry[1] !== undefined));
        return leanApp;
    });
}
describe("appUtils", () => {
    describe("getPlatformsFromFolder", () => {
        ...
        it("should return WEB if package.json exists", async () => {
            ...
            const platforms = await (0, appUtils_1.getPlatformsFromFolder)(testDir);
            (0, chai_1.expect)(platforms).to.have.deep.members([appUtils_1.Platform.WEB]);
        });
        it("should return ANDROID if src/main exists", async () => {
            ...
            const platforms = await (0, appUtils_1.getPlatformsFromFolder)(testDir);
            (0, chai_1.expect)(platforms).to.have.deep.members([appUtils_1.Platform.ANDROID]);
        });
        it("should return IOS if .xcodeproj exists", async () => {
            ...
            const platforms = await (0, appUtils_1.getPlatformsFromFolder)(testDir);
            (0, chai_1.expect)(platforms).to.have.deep.members([appUtils_1.Platform.IOS]);
        });
        it("should return FLUTTER if pubspec.yaml exists", async () => {
            ...
            const platforms = await (0, appUtils_1.getPlatformsFromFolder)(testDir);
            (0, chai_1.expect)(platforms).to.have.deep.members([appUtils_1.Platform.FLUTTER]);
        });
        it("should return FLUTTER and WEB if both identifiers exist", async () => {
            mockfs({ [testDir]: { "package.json": "{}", "pubspec.yaml": "name: test" } });
            const platforms = await (0, appUtils_1.getPlatformsFromFolder)(testDir);
            (0, chai_1.expect)(platforms).to.have.deep.members([appUtils_1.Platform.FLUTTER, appUtils_1.Platform.WEB]);
        });
        it("should return an empty array if no identifiers exist", async () => {
            mockfs({ [testDir]: {} });
            const platforms = await (0, appUtils_1.getPlatformsFromFolder)(testDir);
            (0, chai_1.expect)(platforms).to.be.empty;
        });
    });
    describe("detectApps", () => {
        const testDir = "test-dir";
        ...
        it("should detect a web app", async () => {
            mockfs({ [testDir]: { "package.json": "{}" } });
            const apps = cleanUndefinedFields(await (0, appUtils_1.detectApps)(testDir));
            (0, chai_1.expect)(apps).to.have.deep.members([
                {
        ...
        it("should detect an android app", async () => {
            ...
            (0, chai_1.expect)(apps).to.have.deep.members([
                {
                    platform: appUtils_1.Platform.ANDROID,
                    directory: ".",
                },
            ]);
        });
        ...
        it("should detect an ios app", async () => {
            ...
            (0, chai_1.expect)(apps).to.have.deep.members([
                {
                    platform: appUtils_1.Platform.IOS,
                    directory: ".",
                },
            ]);
        });
        ...
        it("should detect a flutter app", async () => {
            ...
            (0, chai_1.expect)(apps).to.have.deep.members([
                {
                    platform: appUtils_1.Platform.FLUTTER,
                    directory: ".",
                },
            ]);
        });
        ...
        it("should detect an admin app with firebase-admin dependency", async () => {
            ...
            (0, chai_1.expect)(apps).to.have.deep.members([
                {
                    platform: appUtils_1.Platform.ADMIN_NODE,
                    directory: ".",
                },
            ]);
        });
        ...
        it("should detect multiple top-level and nested apps", async () => {
            ...
            (0, chai_1.expect)(apps).to.have.deep.members(expected);
        });
    });
    describe("extractAppIdentifiers", () => {
        it("should extract all app IDs and bundle IDs from a firebase_options.dart file", () => {
            ...
            const result = (0, appUtils_1.extractAppIdentifiersFlutter)(FLUTTER_CONFIG);
            (0, chai_1.expect)(result).to.deep.equal(expectedIdentifiers);
        });
        it("should extract the GOOGLE_APP_ID and BUNDLE_ID from a GoogleService-Info.plist file", () => {
            ...
            const result = (0, appUtils_1.extractAppIdentifierIos)(IOS_CONFIG_1);
            (0, chai_1.expect)(result).to.deep.equal(expectedIdentifier);
        });
        it("should extract all mobilesdk_app_id and package_name from a google-services.json file", () => {
            ...
            const result = (0, appUtils_1.extractAppIdentifiersAndroid)(ANDROID_CONFIG_COMBINED);
            (0, chai_1.expect)(result).to.deep.equal(expectedIdentifiers);
        });
    });
});
//# sourceMappingURL=appUtils.spec.js.map