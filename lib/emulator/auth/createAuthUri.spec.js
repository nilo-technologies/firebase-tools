...
(0, setup_1.describeAuthEmulator)("accounts:createAuthUri", ({ authApi }) => {
    ...
    it("should not show registered field with improved email privacy enabled", async () => {
        ...
        await authApi()
            ...
            .then((res) => {
            (0, helpers_1.expectStatusCode)(200, res);
            (0, chai_1.expect)(res.body).to.not.have.property("registered");
            (0, chai_1.expect)(res.body).to.have.property("sessionId").that.is.a("string");
        });
    });
    ...
    it("should not return providers for a registered user with improved email privacy enabled", async () => {
        ...
        await authApi()
            ...
            (0, helpers_1.expectStatusCode)(200, res);
            (0, chai_1.expect)(res.body).to.not.have.property("registered");
            (0, chai_1.expect)(res.body).to.not.have.property("allProviders").eql(["password"]);
            (0, chai_1.expect)(res.body).to.not.have.property("signinMethods").eql(["password"]);
            (0, chai_1.expect)(res.body).to.have.property("sessionId").that.is.a("string");
        });
    });
