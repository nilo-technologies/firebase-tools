...
const publisherApi = require("./publisherApi");
...
describe("createExtensionVersionFromGitHubSource", () => {
    ...
    it("should throw a FirebaseError if createExtensionVersionFromLocalSource returns an error response", async () => {
        nock(api.extensionsPublisherOrigin())
            .post(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}/versions:createFromSource`)
            .reply(500);
        await (0, chai_1.expect)(publisherApi.createExtensionVersionFromGitHubSource({
    ...
    it("stop polling and throw if the operation call throws an unexpected error", async () => {
        ...
        await (0, chai_1.expect)(publisherApi.createExtensionVersionFromGitHubSource({
            ...
            sourceRef: "HEAD",
            extensionRoot: "/",
        })).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 502, Unknown Error");
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(publisherApi.createExtensionVersionFromGitHubSource({
            ...
            sourceRef: "HEAD",
            extensionRoot: "/",
        })).to.be.rejectedWith(error_1.FirebaseError, "Extension version ref");
    });
});
describe("createExtensionVersionFromLocalSource", () => {
    ...
    it("should throw a FirebaseError if createExtensionVersionFromLocalSource returns an error response", async () => {
        nock(api.extensionsPublisherOrigin())
            .post(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}/versions:createFromSource`)
            .reply(500);
        await (0, chai_1.expect)(publisherApi.createExtensionVersionFromLocalSource({
            extensionVersionRef: `${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`,
            packageUri: "www.google.com/test-extension.zip",
            extensionRoot: "/",
        })).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 500, Unknown Error");
...
describe("getExtension", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsPublisherOrigin())
            .get(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}`)
            .reply(404);
        await (0, chai_1.expect)(publisherApi.getExtension(`${PUBLISHER_ID}/${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(publisherApi.getExtension(`${PUBLISHER_ID}`)).to.be.rejectedWith(error_1.FirebaseError, "Unable to parse");
    });
});
describe("getExtensionVersion", () => {
    ...
    it("should make a GET call to the correct endpoint", async () => {
        ...
        const got = await publisherApi.getExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`);
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsPublisherOrigin())
            .get(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}/versions/${EXTENSION_VERSION}`)
            .reply(404);
        await (0, chai_1.expect)(publisherApi.getExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(publisherApi.getExtensionVersion(`${PUBLISHER_ID}//${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError, "Unable to parse");
    });
});
describe("listExtensions", () => {
    ...
    it("should throw FirebaseError if any call returns an error", async () => {
        ...
        await (0, chai_1.expect)(publisherApi.listExtensions(PUBLISHER_ID)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("listExtensionVersions", () => {
    ...
    it("should send filter query param", async () => {
        nock(api.extensionsPublisherOrigin())
            ...
            .reply(200, PUBLISHED_EXT_VERSIONS);
        const extensions = await publisherApi.listExtensionVersions(`${PUBLISHER_ID}/${EXTENSION_ID}`, "id<1.0.0");
        (0, chai_1.expect)(extensions).to.deep.equal(PUBLISHED_EXT_VERSIONS.extensionVersions);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    ...
    it("should throw FirebaseError if any call returns an error", async () => {
        ...
        nock(api.extensionsPublisherOrigin())
            ...
            .reply(500);
        await (0, chai_1.expect)(publisherApi.listExtensionVersions(`${PUBLISHER_ID}/${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(publisherApi.listExtensionVersions("")).to.be.rejectedWith(error_1.FirebaseError, "Unable to parse");
    });
});
describe("getPublisherProfile", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsPublisherOrigin())
            ...
            .query(true)
            .reply(404);
        await (0, chai_1.expect)(publisherApi.getPublisherProfile(PROJECT_ID)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("registerPublisherProfile", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsPublisherOrigin())
            .patch(`/${VERSION}/projects/${PROJECT_ID}/publisherProfile?updateMask=publisher_id%2Cdisplay_name`)
            .reply(404);
        await (0, chai_1.expect)(publisherApi.registerPublisherProfile(PROJECT_ID, PUBLISHER_ID)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("deprecateExtensionVersion", () => {
    ...
    it("should make a POST call to the correct endpoint", async () => {
        ...
        const res = await publisherApi.deprecateExtensionVersion(TEST_EXT_VERSION_4.ref, "This version is deprecated.");
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        ...
        nock(api.extensionsPublisherOrigin())
            ...
            .post(`/${VERSION}/publishers/${publisherId}/extensions/${extensionId}/versions/${version}:deprecate`)
            .reply(404);
        await (0, chai_1.expect)(publisherApi.deprecateExtensionVersion(TEST_EXT_VERSION_4.ref, "This version is deprecated.")).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("undeprecateExtensionVersion", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        ...
        nock(api.extensionsPublisherOrigin())
            ...
            .post(`/${VERSION}/publishers/${publisherId}/extensions/${extensionId}/versions/${version}:undeprecate`)
            .reply(404);
        await (0, chai_1.expect)(publisherApi.undeprecateExtensionVersion(TEST_EXT_VERSION_3.ref)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
//# sourceMappingURL=publisherApi.spec.js.map