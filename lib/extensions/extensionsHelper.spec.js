...
describe("extensionsHelper", () => {
    ...
    describe("promptForValidInstanceId", () => {
        ...
        it("should prompt the user again if the provided id is shorter than 6 characters", async () => {
            ...
            (0, chai_1.expect)(inputStub).to.have.been.calledTwice;
        });
        ...
        it("should prompt the user again if the provided id ends in a -", async () => {
            ...
            (0, chai_1.expect)(inputStub).to.have.been.calledThrice;
        });
    ...
    describe("checkIfInstanceIdAlreadyExists", () => {
        ...
        it("should throw if it gets an unexpected error response from getInstance", async () => {
            ...
            await (0, chai_1.expect)(extensionsHelper.instanceIdExists("proj", TEST_NAME)).to.be.rejectedWith(error_1.FirebaseError, "Unexpected error when checking if instance ID exists: Internal Error");
        });
    });
    ...
    describe("getNextVersionByStage", () => {
        ...
        it("should return expected stages and versions", async () => {
            listExtensionVersionsStub.returns(Promise.resolve([
            ...
            const { versionByStage, hasVersions } = await extensionsHelper.getNextVersionByStage("test", "1.0.0");
            (0, chai_1.expect)(Array.from(versionByStage.entries())).to.eql(Array.from(expected.entries()));
            (0, chai_1.expect)(hasVersions).to.eql(true);
        });
    ...
    describe("unpackExtensionState", () => {
        ...
        it("should return correct published state", () => {
            (0, chai_1.expect)(extensionsHelper.unpackExtensionState({
                ...testExtension,
                state: "PUBLISHED",
                latestVersion: "1.0.0",
