...
const apphosting = require("./apphosting");
describe("apphosting", () => {
    describe("getNextBuildId", () => {
        ...
        it("should handle explicit counters", async () => {
            ...
            (0, chai_1.expect)(id).matches(new RegExp(`^${idPrefix(new Date())}-001$`));
            (0, chai_1.expect)(listRollouts).to.not.have.been.called;
        });
        it("should handle missing regions (rollouts)", async () => {
            ...
            await (0, chai_1.expect)(apphosting.getNextRolloutId("project", "us-central1", "backend")).to.be.rejectedWith(/unreachable .*us-central1/);
            (0, chai_1.expect)(listRollouts).to.have.been.calledWith("project", "us-central1", "backend");
        });
        ...
        it("should handle the first build of a day", async () => {
            ...
            (0, chai_1.expect)(id).equals(`${idPrefix(new Date())}-001`);
            (0, chai_1.expect)(listRollouts).to.have.been.calledWith("project", "location", "backend");
        });
        it("should increment from the correct date", async () => {
            ...
            const id = await apphosting.getNextRolloutId("project", "location", "backend");
            (0, chai_1.expect)(id).to.equal(`${idPrefix(today)}-002`);
        });
        it("should handle the first build of the day", async () => {
            ...
            const id = await apphosting.getNextRolloutId("project", "location", "backend");
            (0, chai_1.expect)(id).to.equal(`${idPrefix(today)}-001`);
        });
        it("should handle build & rollout names out of sync (build is latest)", async () => {
            ...
            const id = await apphosting.getNextRolloutId("project", "location", "backend");
            (0, chai_1.expect)(id).to.equal(`${idPrefix(today)}-003`);
        });
    ...
    describe("list APIs", () => {
        ...
        it("paginates listBackends", async () => {
            ...
            await (0, chai_1.expect)(apphosting.listBackends("p", "l")).to.eventually.deep.equal({
                backends: [
                    {
                        name: "abc",
                    },
            ...
            (0, chai_1.expect)(get).to.have.been.calledTwice;
            (0, chai_1.expect)(get).to.have.been.calledWithMatch("projects/p/locations/l/backends", {
        ...
        it("paginates listBuilds", async () => {
            ...
            await (0, chai_1.expect)(apphosting.listBuilds("p", "l", "b")).to.eventually.deep.equal({
                builds: [
                    {
                        name: "abc",
                    },
            ...
            (0, chai_1.expect)(get).to.have.been.calledTwice;
            (0, chai_1.expect)(get).to.have.been.calledWithMatch("projects/p/locations/l/backends/b/builds", {
                queryParams: { pageToken: "2" },
            });
        });
        it("paginates listRollouts", async () => {
            ...
            await (0, chai_1.expect)(apphosting.listRollouts("p", "l", "b")).to.eventually.deep.equal({
                rollouts: [
                    {
                        name: "abc",
                    },
            ...
            (0, chai_1.expect)(get).to.have.been.calledTwice;
            (0, chai_1.expect)(get).to.have.been.calledWithMatch("projects/p/locations/l/backends/b/rollouts", {
                queryParams: { pageToken: "2" },
            });
        });
    });
