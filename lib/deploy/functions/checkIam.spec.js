...
const checkIam = require("./checkIam");
...
describe("checkIam", () => {
    ...
    describe("ensureGenkitMonitoringRoles", () => {
        it("should return early if we do not have new endpoints", async () => {
            ...
            await checkIam.ensureGenkitMonitoringRoles(projectId, projectNumber, backend.of(wantFn), backend.of(fn1, fn2, wantFn));
            (0, chai_1.expect)(getIamStub).to.not.have.been.called;
            (0, chai_1.expect)(setIamStub).to.not.have.been.called;
        });
        it("should return early if none of the new endpoints are genkit", async () => {
            ...
            await checkIam.ensureGenkitMonitoringRoles(projectId, projectNumber, backend.of(wantFn1, wantFn2), backend.of(fn1, fn2));
            (0, chai_1.expect)(getIamStub).to.not.have.been.called;
            (0, chai_1.expect)(setIamStub).to.not.have.been.called;
        });
        it("should return early if we fail to get the IAM policy", async () => {
            ...
            await (0, chai_1.expect)(checkIam.ensureGenkitMonitoringRoles(projectId, projectNumber, backend.of(wantFn), backend.empty())).to.not.be.rejected;
            (0, chai_1.expect)(getIamStub).to.have.been.calledOnce;
            (0, chai_1.expect)(getIamStub).to.have.been.calledWith(projectNumber);
            (0, chai_1.expect)(setIamStub).to.not.have.been.called;
        });
        it("should error if we fail to set the IAM policy", async () => {
            ...
            await (0, chai_1.expect)(checkIam.ensureGenkitMonitoringRoles(projectId, projectNumber, backend.of(wantFn), backend.empty())).to.be.rejectedWith("We failed to modify the IAM policy for the project. The functions " +
                "deployment requires specific roles to be granted to service agents," +
                " otherwise the deployment will fail.");
            (0, chai_1.expect)(getIamStub).to.have.been.calledOnce;
            (0, chai_1.expect)(getIamStub).to.have.been.calledWith(projectNumber);
        ...
        it("should not update policy if it already has necessary bindings", async () => {
            ...
            await checkIam.ensureGenkitMonitoringRoles(projectId, projectNumber, backend.of(wantFn), backend.empty());
            (0, chai_1.expect)(getIamStub).to.have.been.calledOnce;
            (0, chai_1.expect)(getIamStub).to.have.been.calledWith(projectNumber);
            (0, chai_1.expect)(setIamStub).to.not.have.been.called;
        });
        it("should update policy if any bindings are missing", async () => {
            ...
            (0, chai_1.expect)(getIamStub).to.have.been.calledWith(projectNumber);
            (0, chai_1.expect)(setIamStub).to.have.been.calledOnce;
            (0, chai_1.expect)(setIamStub).to.have.been.calledWith(projectNumber, {
                etag: "etag",
                version: 3,
                bindings: [
                    BINDING,
        ...
        it("should update policy for all missing roles and service accounts", async () => {
            ...
            await checkIam.ensureGenkitMonitoringRoles(projectId, projectNumber, backend.of(fn1, fn2, fn3, fn4), backend.empty());
            (0, chai_1.expect)(getIamStub).to.have.been.calledOnce;
            (0, chai_1.expect)(getIamStub).to.have.been.calledWith(projectNumber);
            (0, chai_1.expect)(setIamStub).to.have.been.calledOnce;
            (0, chai_1.expect)(setIamStub).to.have.been.calledWith(projectNumber, {
