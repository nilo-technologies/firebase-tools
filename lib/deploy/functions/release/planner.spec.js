...
describe("planner", () => {
    ...
    describe("calculateUpdate", () => {
        ...
        it("allows upgrades of genkit functions from the genkit plugin to firebase-functions SDK", () => {
            ...
            (0, chai_1.expect)(planner.calculateUpdate(genkitFunc, httpsFunc)).to.deep.equal({
                endpoint: genkitFunc,
                unsafe: false,
            });
        });
        ...
        it("knows to delete & recreate for v1 to v2 scheduled function upgrades", () => {
            ...
            const changed = { ...original, platform: "gcfv2" };
            allowV2Upgrades();
            (0, chai_1.expect)(planner.calculateUpdate(changed, original)).to.deep.equal({
                endpoint: changed,
                unsafe: false,
    ...
    describe("toSkipPredicate", () => {
        it("should skip functions with matching hashes", () => {
            ...
            (0, chai_1.expect)(result.region.endpointsToSkip).to.have.lengthOf(1);
            (0, chai_1.expect)(result.region.endpointsToSkip[0].id).to.equal("skip");
        });
        it("should not skip functions with different hashes", () => {
            ...
            const result = planner.calculateChangesets(want, have, (e) => e.region);
            (0, chai_1.expect)(result.region.endpointsToSkip).to.have.lengthOf(0);
            (0, chai_1.expect)(result.region.endpointsToUpdate).to.have.lengthOf(1);
            (0, chai_1.expect)(result.region.endpointsToUpdate[0].endpoint.id).to.equal("func");
        });
        it("should not skip functions with missing hash values", () => {
            ...
            const result = planner.calculateChangesets(want, have, (e) => e.region);
            (0, chai_1.expect)(result.region.endpointsToSkip).to.have.lengthOf(0);
            (0, chai_1.expect)(result.region.endpointsToUpdate).to.have.lengthOf(3);
        });
    ...
    describe("calculateChangesets", () => {
        ...
        it("logs a message when skipping functions", () => {
            ...
            (0, chai_1.expect)(logLabeledBullet).to.have.been.calledWith("functions", "Skipping the deploy of unchanged functions.");
        });
    });
    describe("createDeploymentPlan", () => {
        ...
        it("does not warn users about concurrency when inappropriate", () => {
            allowV2Upgrades();
            const v2Function = { ...func("id", "region"), platform: "gcfv2" };
            ...
            const v1Function = { ...func("id", "region"), platform: "gcfv1" };
            planner.createDeploymentPlan({
    ...
    describe("checkForUnsafeUpdate", () => {
        it("returns true when upgrading from 2nd gen firestore to firestore auth context triggers", () => {
            ...
            (0, chai_1.expect)(planner.checkForUnsafeUpdate(want, have)).to.be.true;
        });
    });
    describe("checkForIllegalUpdate", () => {
        it("prohibits upgrades from v1 to v2", () => {
            const have = { ...func("id", "region"), platform: "gcfv1" };
            const want = { ...func("id", "region"), platform: "gcfv2" };
        ...
        it("should throw if a user downgrades from v2 to v1", () => {
            const want = { ...func("id", "region"), platform: "gcfv1" };
            const have = { ...func("id", "region"), platform: "gcfv2" };
            (0, chai_1.expect)(() => planner.checkForIllegalUpdate(want, have)).to.throw();
        });
    });
    it("detects changes to v2 pubsub topics", () => {
        ...
        let want = { ...func("id", "region"), platform: "gcfv1" };
        let have = { ...func("id", "region"), platform: "gcfv1" };
    ...
    it("detects upgrades to scheduled functions", () => {
        const v1Https = { ...func("id", "region"), platform: "gcfv1" };
        const v1Scheduled = {
            ...func("id", "region", { scheduleTrigger: {} }),
            platform: "gcfv1",
        };
        const v2Https = { ...func("id", "region"), platform: "gcfv2" };
        const v2Scheduled = {
            ...func("id", "region", { scheduleTrigger: {} }),
            platform: "gcfv2",
        };
