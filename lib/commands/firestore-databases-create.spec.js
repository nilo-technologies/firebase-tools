...
const firestore_databases_create_1 = require("./firestore-databases-create");
...
describe("firestore:databases:create", () => {
    ...
    let requireAuthStub;
    beforeEach(() => {
        command = firestore_databases_create_1.command;
    ...
    const mockDatabaseResp = (overrides) => {
        return {
    ...
    it("should create a new database with the correct parameters", async () => {
        ...
        (0, chai_1.expect)(result).to.deep.equal(expectedDatabase);
    ...
    it("should throw an error if location is not provided", async () => {
        ...
        await (0, chai_1.expect)(command.runner()(DATABASE, options)).to.be.rejectedWith(error_1.FirebaseError, "Missing required flag --location");
    });
    it("should throw an error for invalid delete protection option", async () => {
        ...
        await (0, chai_1.expect)(command.runner()(DATABASE, options)).to.be.rejectedWith(error_1.FirebaseError, "Invalid value for flag --delete-protection");
    });
    it("should throw an error for invalid point-in-time recovery option", async () => {
        ...
        await (0, chai_1.expect)(command.runner()(DATABASE, options)).to.be.rejectedWith(error_1.FirebaseError, "Invalid value for flag --point-in-time-recovery");
    });
    it("should throw an error for invalid edition option", async () => {
        ...
        await (0, chai_1.expect)(command.runner()(DATABASE, options)).to.be.rejectedWith(error_1.FirebaseError, "Invalid value for flag --edition");
    });
    ...
    it("should throw an error if the API call fails", async () => {
        ...
        await (0, chai_1.expect)(command.runner()(DATABASE, options)).to.be.rejectedWith(apiError);
    });
});
//# sourceMappingURL=firestore-databases-create.spec.js.map